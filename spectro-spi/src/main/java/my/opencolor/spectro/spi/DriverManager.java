...
public abstract class DriverManager
{
    ...
    public static DriverManager getInstance()
    {
        ...
        {
            m_Logger = Logger.getLogger( DriverManager.class.getName() );
            if( m_Instance != null )
                return m_Instance;

            String clsname = System.getProperty( "my.opencolor.spectro.spi.DriverManager.class", "my.opencolor.spectro.spi.DriverManagerImpl" );
            try
            {
                ...
                {
                    m_Logger.warning( "Specified DriverManager class '" + clsname + "' is not a subclass of " + DriverManager.class.getName() + "." );
