...
public class CapabilityCommand implements SpectroCommand
{
	...
	/* (non-Javadoc)
	 * @see my.opencolor.spectro.spi.SpectroCommand#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see my.opencolor.spectro.spi.SpectroCommand#construct()
	 */
	...
	/* (non-Javadoc)
	 * @see my.opencolor.spectro.spi.SpectroCommand#interpret(byte[])
	 */
