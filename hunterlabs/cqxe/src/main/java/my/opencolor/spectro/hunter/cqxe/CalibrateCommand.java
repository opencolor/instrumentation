...
{
    private static Logger m_Logger = Logger.getLogger(CalibrateCommand.class.getName());
    ...
    public SpectroEvent interpret(byte[] received)
    {
        ...
        {
            m_Logger.info( "Detected : " + Hex.hexStringToInt( portPlateStr ) );
            m_Logger.info( "Set      : " + currentPortPlate );
            status = new CQXEStatus();
