 ...
 */
public class LSXEDriver implements SpectroDriver
{
    ...
    public void initialize()
    {
        ...
        m_Apertures = new Aperture[] { new LargeAperture(), new MediumAperture(), new NormalAperture(), new SmallAperture(), new UltraSmallAperture()};

        m_LightFilters = new LightFilter[] { new UVIncludedLightFilter(), };

        m_LensPositions = new LensPosition[] { new LargeAreaView(), new MediumAreaView(), new NormalAreaView(), new SmallAreaView(), new UltraSmallAreaView()};
    ...
    public String getLocalizedText(String text, Locale locale)
    {
        try
        {
            return ResourceBundle.getBundle("my.opencolor.spectro.drivers.hunter.Bundle", locale).getString(text);
        }
