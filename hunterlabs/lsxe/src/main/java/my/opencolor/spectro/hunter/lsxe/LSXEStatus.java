...
import my.opencolor.spectro.hunter.common.Binary;
import my.opencolor.spectro.hunter.common.Hex;
    ...
    implements SpectroStatus
{
    ...
    public static LSXEStatus create( String response )
    {
        ...
        switch( response.charAt( 0 ) )
	{
        ...
        return new LSXEStatus( msg, warningMsg, errorMsg );
    }
    ...
    LSXEStatus(Collection messages, Collection warnings, Collection errors)
    {
    ...
    public static void checkMeasureStatus( String response, final Collection msg, final Collection warningMsg, final Collection errorMsg )
    {
    ...
    public static void checkCalibrationStatus( String response, final Collection msg, final Collection warningMsg, final Collection errorMsg )
    {
	if( '0' == response.charAt( 1 ) )
	{
    ...
    public static void checkStandardizationStatus( String response, final Collection msg, final Collection warningMsg, final Collection errorMsg )
    {
    ...
    public static void checkErrorStatus( String response, final Collection msg, final Collection warningMsg, final Collection errorMsg )
    {
