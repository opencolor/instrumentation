...
package my.opencolor.spectro.datacolor.sf450;
 ...
 */
public class SF450Driver implements SpectroDriver
{
    static
    {
        ...
        try
        {
            manager.registerDriver( SF450Driver.class );
        }
        catch( my.opencolor.spectro.spi.SpectroException ex )
        {
            System.err.println( "Unable to register SF450 Driver " );
    ...
    public void initialize()
    {
        ...
        m_LensPositions = new LensPosition[]{ new UltraSmallAreaView(), new SmallAreaView(), new LargeAreaView() };

        m_Apertures = new Aperture[]{ new UltraSmallAperture(), new SmallAperture(), new LargeAperture() };
