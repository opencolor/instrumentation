    ...
    implements SpectroStatus
{
    ...
    public static SF450Status create( String response )
    {
        ...
        try
        {
            ...
            {
                errorMsg.add( "MSG_CALIBRATIO_ERROR" );
            }
            ...
            {
                errorMsg.add( "MSG_MEASUREMENT_ENERGY_TOO_LOW" );
            }
            ...
            return new SF450Status( msg, warningMsg, errorMsg );
        }
    ...
    SF450Status( Collection messages, Collection warnings, Collection errors )
    {
