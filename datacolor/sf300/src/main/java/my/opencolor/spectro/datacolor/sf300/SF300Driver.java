...
package my.opencolor.spectro.datacolor.sf300;
 ...
 */
public class SF300Driver implements SpectroDriver
{
    static
    {
        ...
        try
        {
            manager.registerDriver( SF300Driver.class );
        }
        catch( my.opencolor.spectro.spi.SpectroException ex )
        {
            System.err.println( "Unable to register SF300 Driver" );
    ...
    public void initialize()
    {
        ...
        m_LensPositions = new LensPosition[]{ new UltraSmallAreaView(), new LargeAreaView() };

        m_Apertures = new Aperture[]{ new UltraSmallAperture(), new LargeAperture() };
