    ...
    implements SpectroStatus
{
    ...
    public static SF300Status create( String response )
    {
        ...
        try
        {
            ...
            return new SF300Status( msg, warningMsg, errorMsg );
        }
    ...
    SF300Status( Collection messages, Collection warnings, Collection errors )
    {
