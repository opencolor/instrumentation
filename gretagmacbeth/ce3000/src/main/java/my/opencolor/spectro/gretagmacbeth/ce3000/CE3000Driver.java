...
//    }
    ...
    public String getLocalizedText( String text, Locale locale )
    {
        try
        {
            return ResourceBundle.getBundle( "my.opencolor.spectro.drivers.ce3000.Bundle", locale ).getString( text );
        }
    ...
    /* (non-Javadoc)
      * @see my.opencolor.spectro.spi.SpectroDriver#getBaudRates()
      */
    ...
    /* (non-Javadoc)
      * @see my.opencolor.spectro.spi.SpectroDriver#canUIBaudRate()
      */
