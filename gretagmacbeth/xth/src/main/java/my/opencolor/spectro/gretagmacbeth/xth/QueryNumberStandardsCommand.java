...
{
    static private Logger m_Logger = Logger.getLogger( QueryNumberStandardsCommand.class.getName() );

    /**
     * standard command name
     */
    public static final String NAME = "query number standards command";
    ...
    public SpectroEvent interpret( byte[] response )
    {
        ...
        // KH Mar 17, 2004 - response doesn't send a status, so creating an "all's good" status... unneeded, but decided to fill in one
