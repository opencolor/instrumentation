...
package my.opencolor.spectro.gretagmacbeth.xth;
        ...
        if( !m_Incoming.isEmpty() )
        {
            ...
            if( evt != null )
            {
                ...
                else if( cmd instanceof RetrieveStoredReflectanceCommand )
                {
                    ...
                    if( RetrieveStoredReflectanceCommand.TYPE_STANDARD.equals( ( (RetrieveStoredReflectanceCommand) cmd ).getReflectanceType() ) )
                    {
                        notifyStandardRetrieved( evt );
                    }
                    else if( RetrieveStoredReflectanceCommand.TYPE_TRIAL.equals( ( (RetrieveStoredReflectanceCommand) cmd ).getReflectanceType() ) )
                    {
