 ...
 * @author  chc
 */
public class CE2180Reading implements SpectroReading {
    private SpectroStatus m_Status;
    private SpectroSettings m_Settings;
    private Map m_Values;
    
    /** Creates a new instance of CE2180Reading */
    public CE2180Reading( SpectroStatus status, SpectroSettings settings, Map values ) {
        m_Status = status;
        m_Settings = settings;
        m_Values = values;
    }
