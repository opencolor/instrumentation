...
package my.opencolor.spectro.drivers.sp62;
 ...
 */
public class SP62Driver implements SpectroDriver
{
    ...
    static
    {
        ...
        try
        {
            manager.registerDriver( SP62Driver.class );
        }
        catch( my.opencolor.spectro.spi.SpectroException ex )
        {
            Logger.getLogger( SP62Driver.class.getName() ).log( Level.SEVERE, "Unable to register SP62 Driver", ex );
        }
    }
    ...
    public String getLocalizedText( String text, Locale locale )
    {
        try
        {
            return ResourceBundle.getBundle( "my.opencolor.spectro.drivers.sp62.Bundle", locale ).getString( text );
        }
