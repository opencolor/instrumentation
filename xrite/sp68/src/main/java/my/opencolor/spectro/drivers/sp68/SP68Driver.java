...
package my.opencolor.spectro.drivers.sp68;
 ...
 */
public class SP68Driver implements SpectroDriver
{
    static
    {
        ...
        try
        {
            manager.registerDriver( SP68Driver.class );
        }
        catch( my.opencolor.spectro.spi.SpectroException ex )
        {
            System.err.println( "Unable to register SP68 Driver" );
            ex.printStackTrace( System.err );
        }
    }

    private boolean m_RetrieveSample;
    ...
    public String getLocalizedText( String text, Locale locale )
    {
        try
        {
            return ResourceBundle.getBundle( "my.opencolor.spectro.drivers.sp68.Bundle", locale ).getString( text );
        }
