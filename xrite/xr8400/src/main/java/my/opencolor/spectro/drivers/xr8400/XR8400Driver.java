...
public class XR8400Driver implements SpectroDriver
{
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#getName()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#getManufacturer()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#canRetrieveReflectances()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#canRetrieveStandards()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#canMeasureReflectance()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#canMeasureTransmittance()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#canIncludeSpecular()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#canExcludeSpecular()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#usesSerialPorts()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#getFilters()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#getStartingWavelength()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#getEndingWavelength()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#getInterval()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#getWhiteTilePrecision()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#getEstimatedAccuracy()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#getApertures()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#canMeasureOffline()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#getNoOfOfflineMeasurements()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#getNoOfOfflineStandards()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#initialize()
     */
    public void initialize() throws SpectroException
    {
        if( m_Spectro != null )
        {
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#dispose()
     */
    public void dispose() throws SpectroException
    {
        if( m_Spectro != null )
        {
            m_Spectro.dispose();
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#createSpectrophotometer()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#getParameterDefinitions()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#getLensPositions()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#doesBlackCalibrationFirst()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#canBlackCalibrate()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#canWhiteCalibrate()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#getCalibrationSteps()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#getCalibrationDataFiles()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#getLocalizedText(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#canUIApertures()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#canUILensPositions()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#canUISpecular()
     */
     ...
     * (non-Javadoc)
     * 
     * @see my.opencolor.spectro.spi.SpectroDriver#canUIUVFilters()
     */
