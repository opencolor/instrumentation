...
//            int m_intervalvalue = new Integer(m_interval.getSelectedItem().toString()).intValue();
    ...
    private void m_applyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_applyActionPerformed
...
//        m_total = 0;
    ...
    private void m_intervalItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_m_intervalItemStateChanged
//        m_total = 0;
