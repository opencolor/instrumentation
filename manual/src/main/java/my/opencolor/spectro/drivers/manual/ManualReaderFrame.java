...
//	}
	...
	private void reload_list()
	{
		...
		while ( keys.hasNext() )
		{
			...
			m_total_count = m_total_count + m_value.doubleValue();
			m_label_text = m_label_text + "<p><b>" + m_input.intValue() + "&nbsp;nm</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + m_value.toString();
	...
	private void update_import( java.util.SortedMap readings, String filename )
	{
		...
		while ( keys.hasNext() )
		{
			...
			try
			{
				...
				// Setup the label
				m_total_count = m_total_count + m_value.doubleValue();
				m_label_text = m_label_text + "<p><b>" + key + "&nbsp;nm</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + m_value.toString();
			}
			catch ( NumberFormatException e )
			{
				// show the error dailog box
				javax.swing.JFrame frame = new javax.swing.JFrame();
				javax.swing.JOptionPane.showMessageDialog( frame, "Invalid value entered in the import file [" + filename + "] for " + key, "Input Error", javax.swing.JOptionPane.ERROR_MESSAGE );
...
//			String m_length = ( String ) m_in_interval.getSelectedItem();
	...
	private void m_okActionPerformed( java.awt.event.ActionEvent evt )
	{
		...
		catch ( NumberFormatException e )
		{
			// show the error dailog box
			javax.swing.JFrame frame = new javax.swing.JFrame();
			javax.swing.JOptionPane.showMessageDialog( frame, "Invalid value entered", "Input Error", javax.swing.JOptionPane.ERROR_MESSAGE );
		}
	}
