    ...
    implements SpectroDriver
{
    ...
    static
    {
        ...
        try
        {
            manager.registerDriver( CM3600dDriver.class );
        }
        catch( my.opencolor.spectro.spi.SpectroException ex )
        {
            System.err.println( "Unable to register CM3600d Driver" );
            ex.printStackTrace( System.err );
        }
    }

    public CM3600dDriver()
    {
        initialize();
    }
