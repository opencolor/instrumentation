 ...
 * @author  chc
 */
public class SDSCommand implements SpectroCommand
{
    ...
    /** Creates a new instance of SDSCommand */
    public SDSCommand ( String SpecimenNumber, String[] Reflectance, String DataID, String Comment )
    {
        m_SpecimenNumber = SpecimenNumber;
    ...
    {
        return "Speciment Data Set Command";
    }
