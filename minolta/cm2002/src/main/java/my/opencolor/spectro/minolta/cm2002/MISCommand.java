 ...
 * @author  chc
 */
public class MISCommand implements SpectroCommand
{
    private String m_Reference;
    private String m_Test;    
    
    /** Creates a new instance of MISCommand */
    public MISCommand ( String Reference, String Test )
    {
    ...
    {
        return "Metamerism Illuminant Set Command";
    }
