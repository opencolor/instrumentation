 ...
 * @author  chc
 */
public class RCSCommand implements SpectroCommand
{
    private String m_correction;
    
    /** Creates a new instance of RCSCommand */
    public RCSCommand ( String correction )
    {
    ...
    {
        return "Reflectance Correction Factor Set Command";
    }
