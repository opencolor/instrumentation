 ...
 */
public class CM503cDriver implements SpectroDriver
{
    static {
        DriverManager manager = DriverManager.getInstance();
        try
        {
            manager.registerDriver(CM503cDriver.class);
        }
        catch ( my.opencolor.spectro.spi.SpectroException ex)
        {
            System.err.println("Unablte to register CM503cDriver");
    ...
    private String[] m_CalibrationSteps = { "MSG_WHITE" };

    private String[] m_CalibrationDataFiles = null;
    ...
    public void initialize()
    {
        ...
        /*m_LensPositions = new LensPosition[]
        {
            new LargeAreaView (),
            new MediumAreaView (),
            new SmallAreaView ()
        ...
        m_LightFilters = null;
        /*m_LightFilters = new LightFilter[]
        { new UVExcludedLightFilter () };*/
