 ...
 */
public class CM508cStatus implements SpectroStatus
{
    Collection m_ErrorMessages;
    Collection m_WarningMessages;
    Collection m_Messages;
    
    public static CM508cStatus create ( String response )
    {
        ...
        try
        {
            ...
            return new CM508cStatus ( msg, warningMsg, errorMsg );
        }
    ...
    CM508cStatus (Collection messages, Collection warnings, Collection errors)
    {
