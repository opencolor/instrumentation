...
package my.opencolor.spectro.minolta.cm3700d;
 ...
 */
public class CM3700dStatus implements SpectroStatus
{
    Collection m_ErrorMessages;
    Collection m_WarningMessages;
    Collection m_Messages;
    
    public static CM3700dStatus create ( String response )
    {
        ...
        return new CM3700dStatus ( msg, warningMsg, errorMsg );
        
    }
    
    private CM3700dStatus ()
    {
    }
    
    CM3700dStatus (Collection messages, Collection warnings, Collection errors)
    {
